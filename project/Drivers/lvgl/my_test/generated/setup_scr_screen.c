...
void setup_scr_screen(lv_ui *ui)
{
    ...
    lv_obj_set_pos(ui->screen_btn_1, 310, 193);
    lv_obj_set_size(ui->screen_btn_1, 179, 93);
    ...
    lv_obj_set_pos(ui->screen_btn_2, 316, 70);
    lv_obj_set_size(ui->screen_btn_2, 168, 93);
    ...
    lv_obj_set_style_bg_color(ui->screen_btn_2, lv_color_hex(0x292929), LV_PART_MAIN|LV_STATE_DEFAULT);
